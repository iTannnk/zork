    ...
    <main>
      <div className="about-main-container container">
        ...
        <p className="paragraph-container container">
          ...
          to be passed to it and so that the user on the front end can see and
        ...
        <p className="paragraph-container container">
          ...
          in strings and could easily read them out like an Index where
          everything was and I could easily delete add and edit with the help of
          Thunder Client and MongoDB together.
        </p>
        <p className="paragraph-container container">
          ...
          wasn't able to initiate an Auth0 login prompt. I wanted to add an
          Auth0 login prompt because it would enable secure access to the
          editing side of the front end site while on the website, which meant
          you could directly delete features of the zork messages, hence the
